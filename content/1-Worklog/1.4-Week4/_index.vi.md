...
| 4 | **Học Module 04 – Dịch vụ lưu trữ trên AWS**<br>- 04-02: Amazon S3, Access Point và các Storage Class.<br>- 04-03: S3 Static Website, CORS, kiểm soát truy cập, object key, hiệu năng và S3 Glacier.<br>- 04-04: AWS Snow Family, Storage Gateway và AWS Backup.<br>- So sánh object storage, hybrid storage và backup để lựa chọn đúng dịch vụ theo yêu cầu workload. | 15/07/2026 | 15/07/2026 | [Module 04-02 – Amazon S3, Access Point và Storage Class](https://www.youtube.com/watch?v=_yunukwcAwc)<br>[Module 04-03 – S3 Static Website, CORS, kiểm soát truy cập, hiệu năng và Glacier](https://www.youtube.com/watch?si=OITIt1x3d7OZ4ei_&v=mPBjB6Ltl_Q&feature=youtu.be)<br>[Module 04-04 – Snow Family, Storage Gateway và AWS Backup](https://www.youtube.com/watch?v=YXn8Q_Hpsu4) |
